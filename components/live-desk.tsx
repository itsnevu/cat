...
export function LiveDesk() {
  ...
  function decide(ok: boolean) {
    ...
    setPhase("done");
    setToast(ok ? "ANSWERED · DEMO ONLY · REAL APPROVAL HAPPENS IN-SESSION" : "REFUSED · THE GATE STAYS CLOSED");
  }
      ...
      <div className="wrap">
        <div className="sec-head">
          <div>
            ...
            <h2>
              Watch one idea<br />face the Sphinx.
            </h2>
          </div>
          <p>
            A simulated desk run: sense, three analysts, the riddle, a preview. It always stops at your
            answer. This demo places nothing.
          </p>
        </div>
        ...
        <div className="livedesk">
          ...
          <div className="term" style={{ position: "relative" }}>
            ...
            <div className="term-bar">
              ...
              <span className="grow">sphynx@desk, run</span>
            </div>
