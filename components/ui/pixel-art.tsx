...
export function PixelHill({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 560 220" width="100%" className={className} shapeRendering="crispEdges" aria-hidden="true">
      <path d="M0 220 L120 120 L200 96 L300 88 L400 104 L480 140 L560 200 L560 220 Z" fill="#E8B85A" />
      <path d="M0 220 L120 132 L200 108 L300 100 L400 116 L480 152 L560 210 L560 220 Z" fill="#A67C33" />
      <rect x="150" y="150" width="6" height="14" fill="#A67C33" />
      <rect x="340" y="132" width="6" height="14" fill="#A67C33" />
      <rect x="430" y="150" width="6" height="14" fill="#A67C33" />
    </svg>
  );
}
...
export function PixelBot({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 120 128" className={className} shapeRendering="crispEdges" aria-hidden="true">
      ...
      <rect x="24" y="32" width="72" height="48" fill="#1E1610" />
