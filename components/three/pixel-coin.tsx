...
/**
 * PixelCoin — a spinning voxel $SPHYNX coin built from instanced cubes:
 * sand-gold face + deep-sand-gold rim, dune-dark embossed "S" (the Sphynx
...
const CHARCOAL = "#1E1610"; // embossed "S" — reads dark against the face
const CHARTREUSE = "#E8B85A"; // coin face — the signature accent
const RIM = "#A67C33"; // deep-sand-gold rim
