      ...
      <div className="wrap">
        <div className="sec-head">
          <div>
            ...
            <h2>
              Two ways to let an AI<br />near 24/7 markets.
            </h2>
          </div>
          <p>One hands a black box the keys because the market never closes. The other posts a gatekeeper that never sleeps — and makes every swap answer first.</p>
        </div>
