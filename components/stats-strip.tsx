    ...
    <section className="sec" id="desk">
      <div className="wrap">
        <div className="sec-head">
          <div>
            <span className="eyebrow">// 01, THE GATE</span>
            <h2>
              <DecryptText text="Not a bot that swaps" as="span" />
              <br />
              <DecryptText text="while you sleep." as="span" delay={150} />
            </h2>
          </div>
          <p>
            Stock tokens made the market 24/7 and a swap one click. SPHYNX is the gatekeeper: a team of
            specialist AI analysts researches around the clock, a Risk Manager asks the riddle, and you
            answer last. You approve. It places. Never the other way around.
          </p>
        </div>
