...
export const content: DocContent = {
  ...
  description:
    "Connect Sphynx to your Robinhood Agentic account the safe way: clone the repo, trust the project MCP server, authenticate over OAuth, tighten the permission gate, and write a strategy before your first order.",
