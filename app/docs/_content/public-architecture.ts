...
export const content: DocContent = {
  ...
  description:
    "How Sphynx becomes a public, multi-tenant, 24/7 product on the Robinhood network, pivoted to the safe Rule-Keeper + Portfolio X-Ray concept, with a real backend.",
