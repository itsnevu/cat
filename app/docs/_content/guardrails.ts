...
export const content: DocContent = {
  ...
  blocks: [
    {
      type: "prose",
      md: "Sphynx's safety is **structural, not vibes.** The desk does not stay in bounds because a prompt politely asks it to, it stays in bounds because the boundaries are enforced by files that sit *outside* the agent's reach. Two of them do the heavy lifting: [`CLAUDE.md`](/docs/guardrails), the Portfolio Manager's written operating contract, and [`.claude/settings.json`](/docs/configuration), the tool-permission gate that Claude Code applies to every single tool call.",
    },
    {
      type: "prose",
...
claude mcp remove robinhood-trading`,
    ...
    },
    {
      ...
      right: {
        title: "Sphynx's structural guardrails",
        tone: "good",
        rows: [
