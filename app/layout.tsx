...
const TITLE = "SPHYNX";
const DESC =
  "Markets never close now. Neither does the gatekeeper. SPHYNX researches 24/7, you approve every brokerage order, and on-chain every stock-token swap answers a vault that reverts any breach — behind a scoped, expiring key. Mainnet · unaudited · no track record. Unaffiliated with Robinhood.";

// Favicons come from the file-based metadata convention: app/icon.png + app/apple-icon.png
// (the Sphynx "V" mark). The 1200×630 social card comes from app/opengraph-image.tsx —
...
export const metadata: Metadata = {
  ...
  title: { default: TITLE, template: "%s · SPHYNX" },
  description: DESC,
  applicationName: "SPHYNX",
  keywords: ["Sphynx", "stock tokens", "24/7 markets", "least-privilege AI trading", "agentic AI", "trading desk", "on-chain", "RWA vault", "session key", "Robinhood Chain", "multi-agent", "human-in-the-loop"],
  robots: {
    index: true,
    follow: true,
    googleBot: { index: true, follow: true, "max-image-preview": "large", "max-snippet": -1, "max-video-preview": -1 },
  },
  openGraph: { title: TITLE, description: DESC, type: "website", siteName: "SPHYNX", url: SITE_URL, locale: "en_US" },
